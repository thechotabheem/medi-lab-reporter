    ...
    categories: [
      {
        ...
        fields: [
          ...
          { name: 'indirect_bilirubin', label: 'Indirect Bilirubin', unit: 'mg/dL', normalRange: { min: 0.1, max: 0.9 }, type: 'number' },
    ...
    categories: [
      {
        ...
        fields: [
          ...
          { name: 'bun', label: 'Blood Urea Nitrogen (BUN)', unit: 'mg/dL', normalRange: { min: 7, max: 20 }, type: 'number' },
    ...
    categories: [
      {
        ...
        fields: [
          ...
          { name: 'vldl', label: 'VLDL Cholesterol', unit: 'mg/dL', normalRange: { max: 30 }, type: 'number' },
          { name: 'tc_hdl_ratio', label: 'Total Cholesterol/HDL Ratio', normalRange: { max: 5 }, type: 'number' },
          { name: 'ldl_hdl_ratio', label: 'LDL/HDL Ratio', normalRange: { max: 3.5 }, type: 'number' },
        ],
      },
    ],
  },
