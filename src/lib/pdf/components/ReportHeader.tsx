  ...
  if (isFirstPage) {
    return (
      <View>
        ...
        <View style={[tw('flex-row'), { backgroundColor: '#003366', height: 260, borderRadius: 4, paddingVertical: 5, paddingLeft: 10, paddingRight: 10 }]}>
          {/* Logo - 60% width, fills header */}
          {logoBase64 && (
            <View style={{ width: '60%', justifyContent: 'center' }}>
              <Image src={logoBase64} style={{ height: 250, objectFit: 'contain', objectPosition: 'left' }} />
            </View>
          )}
          {/* Clinic info - 40% */}
