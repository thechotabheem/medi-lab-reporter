  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <CardHeader className="p-5 sm:p-7 h-full flex flex-col justify-center relative z-10">
          <IconWrapper
            variant={iconVariant}
            size="lg"
          ...
          {description && (
            <CardDescription className="text-sm sm:text-base lg:text-lg line-clamp-3 mt-2 sm:mt-3">
              {description}
            </CardDescription>
          )}
        </CardHeader>
